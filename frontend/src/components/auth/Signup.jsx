...
export default function Signup() {
    ...
    const handleSubmit = (e) => {
        ...
        // Validation
        if (!validateForm.required(formData.fullname)) {
        ...
        if (!validateForm.password(formData.password)) {
            ...
            >
                ...
                <div className="relative">
                    <input
                        ...
                        className="input input-bordered input-primary min-w-[16rem] pr-12"
                        name="password"
                ...
                >
                    {signupMutation.isPending && <span className="loading loading-spinner loading-xs"></span>}
                    Sign Up
                </button>
            </form>
        </div>
